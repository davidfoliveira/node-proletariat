...
worker.on('sysmsg',function(msg){
	...
	// Send back the system message
	msg.isThaAnswer = true;
	worker.systemMessage(msg,function(){
		console.log("Everybody received my message");
	});
	worker.systemMessage({hi:"lord"},{to:"MANAGER"},function(){
		console.log("Lord received my message");
	});
});
