...
$(builddir)/nprof: export DYLIB_INSTALL_NAME_BASE := /usr/local/lib
...
$(builddir)/nprof: export LD_DYLIB_INSTALL_NAME := /usr/local/lib/nprof.node
...
LDFLAGS_Debug := \
	...
	-arch x86_64 \
	-L$(builddir) \
	-install_name /usr/local/lib/nprof.node
