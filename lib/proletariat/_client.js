...
function Client(opts) {
	...
	this.servers			= opts.servers		|| [ { host: opts.host || "127.0.0.1", port: opts.port || 1917 } ];
	...
	this._clientResendUnfinished	= _clientResendUnfinished;
...
function _clientConnect() {
	...
	this.connected = false;
	self.s = net.connect(self.servers[self.serverIdx], function(){
...
function _clientResendUnfinished() {
