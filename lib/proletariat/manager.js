...
function _clientRejectWork(c,works,m) {
	...
	if ( m )
		_debug("WARNING: Worker "+c.id+"REJECTED "+works.length+" works ("+JSON.stringify(works)+"). My idea was: "+parseInt(c.availableSlots+m.accepted.length+works.length)+", real: ",m.allocation);
